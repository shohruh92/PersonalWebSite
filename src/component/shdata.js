const shdata = {
  ...
  aboutme: "About Me",
  aboutdetails:
    "I am a qualified and professional web developer with three years of experience in database administration and website design. Strong creative and analytical skills. Team player with an eye for detail. ",
  service: [
    {
      id: 1,
